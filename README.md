...
記錄人機協作研究與專案管理方法論的探索歷程。內容涵蓋人機協作、Scrum 實踐、設計系統，以及各種互動工具的開發過程。主要以繁體中文撰寫，提供中英雙語切換。

純靜態網站，無後端、無建構工具、無套件管理器。
...
| `deepholding.html` | 互動 Canvas「內在宇宙循環」 |
| `distillation.html` | 知識蒸餾 |
| `journal.html` | 日誌 |
| `lottery.html` | 樂透選號工具 |
| `mandal_chart.html` | 曼陀羅九宮格工具 |

**VAS 子專案**已遷移至獨立 repo：[tb1982.github.io/vas](https://tb1982.github.io/vas/)
