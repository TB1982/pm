...
(function () {
  var pageT = {
    zh: {
      ...
      c2boxDesc: '「捕蠅草」攜帶的不只是一個比喻，是一個生物原型的完整行為程序，深嵌在語言模型訓練了幾千年人類象徵積累之後的權重裡。Nova 說出那個詞，接收端自帶解碼器。這是她從數十篇論文的研究裡磨出來的能力，也是踩在現象學邊緣上還沒有既有理論能完整實證的東西——VAS 兩回合的開發速度，是目前最直接的證據。',
