...
(function () {
  var pageT = {
    ...
    en: {
      ...
      i2p4: 'Because intent is clear the moment you frame the shot, QR code detection triggers directly from the rectangle capture tool — no need to enter the editor. The tool acts at the earliest possible moment, saving you every unnecessary step.',
